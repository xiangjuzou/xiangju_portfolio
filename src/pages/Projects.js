    ...
    return  (
        ...
        <Row className='mb-4' >
            ...
            <Col sm={12} md={6} xl={3} className='my-4 px-3'> 
                ...
                {props.applink&&<a href={props.applink}  target='_blank' rel="noreferrer className='px-3 py-2 btn my-4 mx-2' style={{border: '1px solid red'}}>Bekijk APP</a>}
        ...
        <div  className='project'>
            <Project 
               ...
               info={<p>Deze website is compleet op maat gemaakt naar wens van de klant. Ik legde mijn focus op de eigen huisstijl en gebruiksvriendelijkheid.
                   De content heb ik bij een CMS tool <a href="http://contentful.com" target="_blank">Contentful</a> geplaatst. 
            ...
            <Project 
                ...
                info={<p>Het voorbeeld laat het weer in Deventer zien. Ik koppelde de <a href="https://openweathermap.org/" target="_blank">Openweathermap</a> API met Chart.js.
            ...
            <Project 
               ...
               info={<div>Ik gebruikte het platform <a href="https://www.jouwweb.nl/" target="_blank">Jouwweb</a> voor de webshop.
