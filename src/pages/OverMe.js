...
const Overme  = () => {
   ...
   const flipData = [
      ...
      { urllink: 'horse500x333.png', vraag:'Lievelingsliedje', antwoord:'Because of you'},
      { urllink: 'bus500x334.png', vraag:'lievelings APP', antwoord:'Youtube'},
      { urllink: 'summer500x333.png', vraag:'winter of zomer', antwoord:'Zomer'},
      { urllink: 'sheep500x333.png', vraag:'Hond of poesje', antwoord:'Hond'},
  ...
  <Container>
   ...
   <div className='my-5 py-5'>
        <h1 className='my-5 text-center'>Veelgestelde vragen </h1>
            <CollapseVerhaal vraag ='Waarom woon je in Nederland?' verhaal='Ik heb mijn Nederlanse man leren kennen, daarom kwam ik op tweede kerstdag in 2008 hier wonnen. '></CollapseVerhaal>
            <CollapseVerhaal vraag ='Mis je jouw familie?' verhaal='Ik mis ze heel veel, maar het is tegenwoordig makkelijk om contact te houden via het internet. '></CollapseVerhaal>
            <CollapseVerhaal vraag ='Is het Nederlands moeilijk?' verhaal='Ja, vooral de uitspraak. Het kostte me veel tijd om de taal te leren'></CollapseVerhaal>
            <CollapseVerhaal vraag ='Wat zijn je sterkte punten?' verhaal='Ik ben sociaal en kan me goed relativeren. Ik werk hard door om werk voor een deadline af te krijgen.'></CollapseVerhaal>
            <CollapseVerhaal vraag ='Wat zijn je zwarke punten?' verhaal='Ik moet aan mij zelfvertrouwen werkern en mijn doel scherp voor ogen houden. Goed uitdrukken in taal moet ik ook verbeteren.'></CollapseVerhaal>
            <CollapseVerhaal vraag ='Wat doe je in je vrije tijd?' verhaal='Wanderen in de natuur of een bezoek aan een museum brengen maken mijn leven kleurijker. Daarnaast ben ik gek op de architectuur van oude gebouwen.'></CollapseVerhaal>
