...
<div id='home_banner'>
  <Container>
    <div style={{height:'89vh'}} className='d-flex flex-column align-items-center justify-content-center'>
      <div id='home_text'>
        <p className='pb-5 mr-5' style={{fontSize:'43px'}}>Ik ben Xiangju Zou, een enthousiaste <br/>front-end software developer.</p>
        <p className='pb-5 mr-5' style={{fontSize:'34px'}}>Met kennis van HTML5, CSS3, Bootstrap, Javascript,<br/> React, Git en Scrum wil ik graag websites of<br/>web applications ontwikkelen.  </p>
      </div>
